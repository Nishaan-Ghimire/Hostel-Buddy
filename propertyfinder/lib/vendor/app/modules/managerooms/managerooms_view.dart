...
RatingModel('David ', '3.5', 'Good'),
RatingModel('Ramesh ', '4', ' Nice'),
RatingModel('Rahul ', '4.5', 'Best'),
RatingModel('Rohit pudel ', '5', 'Best'),
RatingModel('Dipendra ', '5', 'Best'),
RatingModel('Rock Avi ', '5', 'Best'),
...
Container(
  ...
  Text(' ${controller.items.location}'),
  controller.items.isAvailable=='true'?Text('Available'):Text('Not Available'),

  Text('Rs ${controller.items.price} /month'),
