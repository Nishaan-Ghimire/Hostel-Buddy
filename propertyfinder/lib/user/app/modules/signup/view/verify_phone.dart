...
class PhoneVerificationView extends GetView<SignupController> {
      ...
      children: [
             Align(alignment:Alignment.topLeft,
                      child: Padding(
                        ...
                        child: Text(' Enter OTP sent to your mobile no',style: TextStyle(fontWeight: FontWeight.bold),
                                    //    ZTextString.zEmail,
            ...
            Padding(
                    ...
                    //               child: Text('Skip For Now',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),),
